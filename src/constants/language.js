...
export const PESTICIDE_SALES = {
  ...
  distributedProducts: {
    ...
    content: {
      en: [
        { name: "NASA 36 (Glyphosate 360)", type: "url", url: "../../assets/files/pdf/nasa36.pdf" },
        { name: "FREEDOM GLYPHOSATE POTASSIUM SALT 540 LIQUID HERBICIDE", type: "url" },
        { name: "Lier Glufosinate 150 SN", type: "url" },
        { name: "FOISON Glufosinate Ammonium 200 SN", type: "url" },
        { name: "Brassinolide 0.01%", type: "url" },
      ],
      zh: [
        { name: "NASA 36 (Glyphosate 360)", type: "url" },
        { name: "FREEDOM GLYPHOSATE POTASSIUM SALT 540 LIQUID HERBICIDE", type: "url" },
        { name: "Lier Glufosinate 150 SN", type: "url" },
        { name: "FOISON Glufosinate Ammonium 200 SN", type: "url" },
        { name: "芸苔素内酯 0.01%", type: "url" },
      ],
    },
  },
};
